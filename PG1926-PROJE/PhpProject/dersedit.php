...
<form action="" method="post">
                            ...
                            <input class="btn  btn-success" name="gonderac" value="Dersi Aç" type="submit"/>
                                                    </form>
                            ...
                            <input class="btn  btn-success" name="gonderkapat" value="Dersi Kapat" type="submit"/>
         <br>
                                  <br>
                                  ...
                                  <br>
                                            ...
                                            <input class="btn  btn-success" name="dosyaekle" value="Dosyayı Ekle" type="submit"/>
