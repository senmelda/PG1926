  ...
  <body>
    ...
    <div class="mb-3">
      <label>Bölüm Seçiniz: </label>
       <select class="dersekleform" name="bolum">
       <?php 
    ...
    ?>
      ...
      <select class="dersekleform" name="dersID">
       <?php
      ...
      <input type="text" name="kayit" class="form-control" placeholder="Kayıt Anahtarı Giriniz : ">

      <br>
    <input class="anhtrbuton" name="gonder" value="Kaydol" type="submit"/>
    </form>
    </div>
    <?php
  //  ob_start();
